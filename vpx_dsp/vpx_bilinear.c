...
static void vpx_bilinear_interp_horiz_uint8_c(const uint8_t *src, ptrdiff_t src_stride, int16_t *dst,  ptrdiff_t dst_stride, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
    int x, y;
...
static void vpx_bilinear_interp_horiz_int16_c(const int16_t *src, ptrdiff_t src_stride, int16_t *dst,  ptrdiff_t dst_stride, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
    int x, y;
...
static void vpx_bilinear_interp_vert_uint8_c(const int16_t *src, ptrdiff_t src_stride, uint8_t *dst,  ptrdiff_t dst_stride, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
    int x, y;
...
static void vpx_bilinear_interp_vert_int16_c(const int16_t *src, ptrdiff_t src_stride, uint8_t *dst,  ptrdiff_t dst_stride, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
    int x, y;
...
static void vpx_bilinear_interp_vert_int16_int16_c(const int16_t *src, ptrdiff_t src_stride, int16_t *dst,  ptrdiff_t dst_stride, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
    int x, y;
...
void vpx_bilinear_interp_uint8_c(const uint8_t *src, ptrdiff_t src_stride, uint8_t *dst,  ptrdiff_t dst_stride, int x_offset, int y_offset, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
...
void vpx_bilinear_interp_int16_c(const int16_t *src, ptrdiff_t src_stride, uint8_t *dst,  ptrdiff_t dst_stride, int x_offset, int y_offset, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
    int16_t temp[256 * 256];
...
void vpx_bilinear_interp_int16_int16_c(const int16_t *src, ptrdiff_t src_stride, int16_t *dst,  ptrdiff_t dst_stride, int x_offset, int y_offset, int width, int height, int scale, const palantir_bilinear_coeff_t *config){
    int16_t temp[256 * 256];
    ...
    vpx_bilinear_interp_horiz_int16_c(src, src_stride, temp, 256, width, height, scale, config);
    vpx_bilinear_interp_vert_int16_int16_c(temp, 256, dst, dst_stride, width, height, scale, config);
}