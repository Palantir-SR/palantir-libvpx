...
# PALANTIR decoder version 2
UTILS-$(CONFIG_DECODERS)    += vpxdec_palantir_ver2.c
vpxdec_palantir_ver2.SRCS                 += md5_utils.c md5_utils.h
vpxdec_palantir_ver2.SRCS                 += vpx_ports/mem_ops.h
vpxdec_palantir_ver2.SRCS                 += vpx_ports/mem_ops_aligned.h
vpxdec_palantir_ver2.SRCS                 += vpx_ports/msvc.h
vpxdec_palantir_ver2.SRCS                 += vpx_ports/vpx_timer.h
vpxdec_palantir_ver2.SRCS                 += vpx/vpx_integer.h
vpxdec_palantir_ver2.SRCS                 += args.c args.h
vpxdec_palantir_ver2.SRCS                 += ivfdec.c ivfdec.h
vpxdec_palantir_ver2.SRCS                 += tools_common.c tools_common.h
vpxdec_palantir_ver2.SRCS                 += y4menc.c y4menc.h
ifeq ($(CONFIG_LIBYUV),yes)
  vpxdec_palantir_ver2.SRCS                 += $(LIBYUV_SRCS)
  $(BUILD_PFX)third_party/libyuv/%.cc.o: CXXFLAGS += -Wno-unused-parameter
endif
ifeq ($(CONFIG_WEBM_IO),yes)
  vpxdec_palantir_ver2.SRCS                 += $(LIBWEBM_COMMON_SRCS)
  vpxdec_palantir_ver2.SRCS                 += $(LIBWEBM_MUXER_SRCS)
  vpxdec_palantir_ver2.SRCS                 += $(LIBWEBM_PARSER_SRCS)
  vpxdec_palantir_ver2.SRCS                 += webmdec.cc webmdec.h
endif
